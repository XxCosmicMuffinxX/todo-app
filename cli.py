...
while True:
    ...
    if user_action.startswith("add"):
        todo = user_action[4:] + '\n'
        todos = get_todos(filepath='todos.txt')  # there is no need for the arg in the() it is mentioned in the function
        todos.append(todo)
        write_todos(filepath="todos.txt", todos_args=todos)  # same here only keep in the () the var todos
